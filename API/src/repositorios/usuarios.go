...
// BuscarPorID trás um usuário do banco de dados
...
// BuscarSeguindo trás todos os usuários que um determinado usuário etá seguindo
...
// BuscarSenha trás a senha de um usuário pelo ID
