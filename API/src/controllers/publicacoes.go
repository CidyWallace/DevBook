...
// CriarPublicacao adiciona uma nova publicaçao no banco de dados
...
// BuscarPublicacoes trás as publicações que a parecem no feed do usuário
...
// BuscarPublicacao trás uma unica publicação
...
func AtualizarPublicacao(w http.ResponseWriter, r *http.Request) {
	...
	if publicacaoSalvaNoBanco.AutorID != UsuarioID {
		respostas.Erro(w, http.StatusForbidden, errors.New("você não atualizar uma publicacão que não seja sua"))
		return
	}
...
// DeletarPublicacao exclui os dados uma publicação
...
// CurtirPublicacao adiciona uma curtida em uma publicação
...
// DescurtirPublicacao remove uma curtida de uma publicação
